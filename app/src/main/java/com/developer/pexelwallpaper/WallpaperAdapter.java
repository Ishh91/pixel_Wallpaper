package com.developer.pexelwallpaper;
...
public class WallpaperAdapter extends RecyclerView.Adapter<WallpaperViewHolder> {
    ...
    private List<com.developer.pexelwallpaper.WallpaperModel> wallpaperModelList;

    public WallpaperAdapter(Context context, List<com.developer.pexelwallpaper.WallpaperModel> wallpaperModelList) {
